...
const PlacementPodium = ({scores, players}) => {
    ...
    <div className='PodiumWrapper'>
        ...
        <div id="FirstPodium" >
            <div className="placementBackground"> <h1 className='placementText'>2</h1>
</div>
        </div>
    ...
    <div  className='PodiumWrapper'>
        ...
        <div id="SecondPodium">
        <div className="placementBackground"> <h1 className='placementText'>1</h1>
</div>
        </div>
    ...
    <div className='PodiumWrapper'>
        ...
        <div id="ThirdPodium">
        <div className="placementBackground"> <h1 className='placementText'>3</h1>
</div>
        </div>
